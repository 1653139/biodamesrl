# Attention functions borrowed from https://arxiv.org/pdf/1712.01586.pdf and https://arxiv.org/pdf/1706.03762.pdf
import math

import tensorflow as tf

from biodamesrl.liir.dame.core.nn.thirdparties.Common import linear
...
def attention(query, key, value, bias, key_size, keep_prob=None,
    ...
    Args:
        query: a Tensor with shape [batch, length_q, kdepth_] if
