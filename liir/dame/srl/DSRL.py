...
from biodamesrl.liir.dame.core.io.CoNLL2005Writer import write_props, write_short_conll2005_format
...
from biodamesrl.liir.dame.core.nn.thirdparties.Attention import add_timing_signal, multihead_attention, attention_bias
from biodamesrl.liir.dame.core.nn.thirdparties.Common import linear, layer_norm
...
from biodamesrl.liir.dame.srl.DataProcessor import DataProcessor
    ...
    def embeddings(self):
        ...
        if "char" in self.cfg.emb_type:
            ...
            with tf.variable_scope("chars"):
                ...
                if self.cfg.model_dir == "/export/home1/NoCsBack/hci/dame/char_new":
                    word_char_embeddings = tf.concat([word_embeddings, output], axis=-1)
                else:
                   word_char_embeddings =  output
        ...
        def optimistic_restore_vars(model_checkpoint_path):
            ...
            with tf.variable_scope('', reuse=True):
                for var_name, saved_var_name in var_names:
                    ...
                    print (str(curr_var) + ":" + str(var_shape)  + ":" +str(saved_shapes[saved_var_name]))
